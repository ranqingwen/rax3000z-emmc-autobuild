...
集成软件包
`cfdisk, htop, openssl-util, kmod-fuse, kmod-usb-net-ipheth, kmod-usb-net-rndis, luci-app-argon-config, luci-app-autoreboot, luci-app-alist, luci-app-diskman, luci-app-dockerman, luci-app-frpc, luci-app-ksmbd, luci-app-lucky, luci-app-netdata, luci-app-nlbwmon, luci-app-openclash, luci-app-ttyd, luci-app-uhttpd, luci-app-upnp, luci-app-usb-printer, app-wol, luci-app-zerotier, luci-theme-argon`
等并预置 openclash 内核
